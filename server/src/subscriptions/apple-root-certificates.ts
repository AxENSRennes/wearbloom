// Public trust anchors published at https://www.apple.com/certificateauthority/.
// Keep all current Apple roots so certificate-chain rotation doesn't interrupt purchases.
const appleRootCertificatesPEM = [
  `-----BEGIN CERTIFICATE-----
...
export const appleRootCertificates = appleRootCertificatesPEM.map((certificate) => Buffer.from(certificate));
